...
public:
    ...
    Eigen::Isometry3f TrackStereo(const cv::Mat &imLeft, const cv::Mat &imRight, const double &timestamp);
    ...
    void SaveOfflineTrajectoryTUM(const string &filename);
...
private:
    ...
    std::list<Eigen::Isometry3f> list_of_poses;
    std::list<double> list_of_timestamps;
};
